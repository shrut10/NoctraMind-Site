  ...
  return (
    <section className="space-y-6 max-w-3xl">
      ...
      <p className="opacity-90 leading-relaxed">
        I plan to use this site as my personal research space, a place to experiment with the
        ...
        the technical and the metaphysical rather than treating them as opposing domains.
      </p>
      ...
      <p className="opacity-90 leading-relaxed">
        In the long run, I hope to use this website as an archive of my findings, thoughts and works and eventually I'd like to work towards bridging the rational
        and the mystical without diluting either. It is a record of 
        experimentation and I think the belief that understanding mind in biological or artificial form
